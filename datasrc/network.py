...
Objects = [
	...
	NetObjectEx("MyOwnObject", "my-own-object@sash.mybin.ir", [
		NetIntAny("m_Test"),
	]),
	...
	NetObjectEx("MyOwnEvent", "my-own-event@sash.mybin.ir", [
		NetIntAny("m_Test"),
	]),
]
...
# Can't add any NetMessages here!
	...
	NetMessageEx("Sv_MyOwnMessage", "my-own-message@sash.mybin.ir", [
		NetIntAny("m_Test"),
	]),
]
