...
MACRO_CONFIG_STR(PlayerName, player_name, 16, "Sash Fan", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Name of the player")
MACRO_CONFIG_STR(PlayerClan, player_clan, 12, "Sash Client", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Clan of the player")
...
MACRO_CONFIG_INT(ClDDNetFakeVersion, cl_ddnet_fake_version, 12073, 0, 9999999, CFGFLAG_SAVE|CFGFLAG_CLIENT, "fuck ddnet")
...
MACRO_CONFIG_INT(ClAutoUpdate, cl_auto_update, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Automatically perform updates without bothering you about it")
...
MACRO_CONFIG_STR(BrFilterString, br_filter_string, 64, "", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Server browser filtering string")
MACRO_CONFIG_STR(BrExcludeString, br_exclude_string, 64, "", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Server browser exclusion string")
...
MACRO_CONFIG_INT(BrMaxRequests, br_max_requests, 50, 0, 1000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Number of requests to use when refreshing server browser")
MACRO_CONFIG_INT(BrCurrRequestsAbortLimit, br_curr_requests_abort_limit, 10, 1, 999, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Number of requests to use when refreshing server browser")

MACRO_CONFIG_INT(BrLanScanStart, br_lan_scan_start, 8303, 1, 65535, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Port to start at when looking for servers on your LAN")
MACRO_CONFIG_INT(BrLanScanRange, br_lan_scan_range, 7, 1, 65534, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Number of ports to scan when looking for servers on your LAN, starting at br_lan_scan_start")
...
MACRO_CONFIG_INT(SndHighlightVanilla, snd_highlight_vanilla, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Enable highlighted chat sound vanilla style (otherwise swapped)")
...
MACRO_CONFIG_INT(GfxSimpleWindowTitle, gfx_simple_window_title, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Force window title to always be 'Teeworlds Sash'")
#if defined(__ANDROID__)
...
#else
MACRO_CONFIG_INT(GfxWindowMode, gfx_window_mode, 0, 0, 2, CFGFLAG_SAVE|CFGFLAG_CLIENT, "0: windowed | 1: borderless | 2: fullscreen")
...
MACRO_CONFIG_INT(DbgAStar, dbg_astar, 0, 0, 1, CFGFLAG_CLIENT, "Debug astar data")
...
MACRO_CONFIG_INT(ClLaserInnerHue, cl_laser_inner_hue, 127, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser inner color hue")
MACRO_CONFIG_INT(ClLaserInnerSat, cl_laser_inner_sat, 255, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser inner color saturation")
MACRO_CONFIG_INT(ClLaserInnerLht, cl_laser_inner_lht, 127, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser inner color lightness")

MACRO_CONFIG_INT(ClLaserOutlineHue, cl_laser_outline_hue, 40, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser outline color hue")
MACRO_CONFIG_INT(ClLaserOutlineSat, cl_laser_outline_sat, 255, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser outline color saturation")
MACRO_CONFIG_INT(ClLaserOutlineLht, cl_laser_outline_lht, 128, 0, 255, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Laser outline color lightness")

MACRO_CONFIG_INT(ConnTimeout, conn_timeout, 11, 5, 1000, CFGFLAG_SAVE|CFGFLAG_CLIENT|CFGFLAG_SERVER, "Seconds to wait before disconnection due to Connection Problems")
...
MACRO_CONFIG_INT(ClShowIDsScoreboard, cl_show_ids_scoreboard, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Whether to show client ids in scoreboard")
MACRO_CONFIG_INT(ClShowIDsChat, cl_show_ids_chat, 1, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Whether to show client ids in chat")
...
// fake ping
MACRO_CONFIG_INT(ClFakePingInc, sash_fake_ping_inc, 0, 0, 1000, CFGFLAG_CLIENT, "Fake increase ping. (0 = disabled)")
MACRO_CONFIG_INT(ClFakePingDec, sash_fake_ping_dec, 0, 0, 1000, CFGFLAG_CLIENT, "Fake decrease ping. (0 = disabled)")
...
MACRO_CONFIG_STR(ClTimeoutCod, cl_timeout_cod, 1024, "", CFGFLAG_CLIENT, "Timeout code to use")
MACRO_CONFIG_INT(ClResetLocal, cl_reset_local, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Reset local files")
#ifdef undef1
