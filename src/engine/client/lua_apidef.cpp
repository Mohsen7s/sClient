...
void CLuaFile::RegisterLuaCallbacks(lua_State *L) // LUABRIDGE!
{
	...
	lua_register(L, "SashVersion", CLuaBinding::LuaCompiledInfo);
	lua_register(L, "CpuId", CLuaBinding::CpuId);
	lua_register(L, "PcHash", CLuaBinding::PcHash);
	...
	getGlobalNamespace(L)
		...
		.beginClass<IClient>("IClient")
			...
			//.addProperty("CurrentMapName", &IClient::GetCurrentMapStd)
		...
		.beginClass<CMenus>("CMenus")
			.addProperty("Active", &CMenus::IsActive, CMenus::SetActive)
			.addProperty("ActivePage", &CMenus::GetActivePage, &CMenus::SetActivePage)
			.addProperty("ActivePopup", &CMenus::GetActivePopup)
...
#undef MACRO_TUNING_PARAM
		...
		.beginClass<CControls>("CControls")
			...
			.addProperty("NextWeapon", &CControls::GetNextWeapon, &CControls::SetNextWeapon)
			.addProperty("PreviousWeapon", &CControls::GetPreviousWeapon, &CControls::SetPreviousWeapon)
			...
			.addProperty("Flags", &CControls::GetFlags, &CControls::SetFlags)
			.addFunction("SetScoreboardFlag", &CControls::SetScoreboardFlag)


			.addProperty("DummyDirection", &CControls::GetDummyDirection, &CControls::SetDummyDirection)
			.addProperty("DummyFire", &CControls::GetDummyFire, &CControls::SetDummyFire)
			.addProperty("DummyHook", &CControls::GetDummyHook, &CControls::SetDummyHook)
			.addProperty("DummyJump", &CControls::GetDummyJump, &CControls::SetDummyJump)
			.addProperty("DummyWantedWeapon", &CControls::GetDummyWantedWeapon, &CControls::SetDummyWantedWeapon)
			.addProperty("DummyNextWeapon", &CControls::GetDummyNextWeapon, &CControls::SetDummyNextWeapon)
			.addProperty("DummyPreviousWeapon", &CControls::GetDummyPreviousWeapon, &CControls::SetDummyPreviousWeapon)
			.addProperty("DummyTargetX", &CControls::GetDummyTargetX, &CControls::SetDummyTargetX)
			.addProperty("DummyTargetY", &CControls::GetDummyTargetY, &CControls::SetDummyTargetY)
			.addProperty("DummyMouseX", &CControls::GetDummyMouseX, &CControls::SetDummyMouseX)
			.addProperty("DummyMouseY", &CControls::GetDummyMouseY, &CControls::SetDummyMouseY)
			.addProperty("DummyFlags", &CControls::GetDummyFlags, &CControls::SetDummyFlags)
			.addFunction("DummySetScoreboardFlag", &CControls::SetDummyScoreboardFlag)
		...
		/*	.addData("Chat", &CGameClient::m_pChat)
			...
			.addFunction("SendPlayerInfo", &CGameClient::SendInfo)
			.addFunction("SendDummyInfo", &CGameClient::SendDummyInfo)
		...
		.beginNamespace("Game")
			...
			.addVariable("MainTee", &CLua::m_pCGameClient->m_aClients[CLua::m_pCGameClient->Client()->m_LocalIDs[g_Config.m_ClDummy]].m_Predicted, false)
			.addVariable("DummyTee", &CLua::m_pCGameClient->m_aClients[CLua::m_pCGameClient->Client()->m_LocalIDs[!g_Config.m_ClDummy]].m_Predicted, false)
			.addVariable("LocalCID", &CLua::m_pCGameClient->m_Snap.m_LocalClientID, false)
			.addVariable("MainID", &CLua::m_pCGameClient->Client()->m_LocalIDs[0], false)
			.addVariable("DummyID", &CLua::m_pCGameClient->Client()->m_LocalIDs[1], false)
