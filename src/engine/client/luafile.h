...
public:
	CLuaFile(CLua *pLua, const std::string& Filename, bool Autoload, bool LoadAsString = false, int LoadStringSize = 0, const std::string& ScriptData = "" );
	~CLuaFile();
