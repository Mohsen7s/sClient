...
MACRO_CONFIG_INT(ClAntiPingLimit, cl_antiping_limit, 1, 0, 200, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Antiping limit (0 to disable)")
MACRO_CONFIG_INT(ClAntiPing, cl_antiping, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Enable antiping, i. e. more aggressive prediction.")
...
MACRO_CONFIG_INT(ClShowhudServerRecord, cl_showhud_server_record, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Server record below race timer")
...
MACRO_CONFIG_INT(ClShowChatCryptData, cl_show_chat_cryptdata, 0, 0, 3, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0=show none | 1=show theirs | 2=show ours | 3=show both")
...
MACRO_CONFIG_INT(ClShowfpsPos, cl_showfps_pos, 0, 0, 3, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Position of the ingame FPS counter (0: BR; then CW)")
MACRO_CONFIG_INT(ClShowpredPos, cl_showpred_pos, 0, 0, 3, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Position of the ingame prediction time in milliseconds")
...
MACRO_CONFIG_INT(ClDefaultZoom, cl_default_zoom, 8, 0, 20, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Default zoom level (10 default, min 0, max 20)")
...
MACRO_CONFIG_STR(ClPlayerSkin, player_skin, 24, "Cowgirl", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Player skin")
...
// dummy
MACRO_CONFIG_STR(ClDummyName, dummy_name, 16, "Sash dummy", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Name of the Dummy")
...
// haxx
MACRO_CONFIG_INT(BrAutoRefresh, br_auto_refresh, 60, 0, 3600, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Time in secs to refresh the serverbrowser when active (0 disables)")
...
MACRO_CONFIG_INT(ClPathFindingColorG, cl_path_finding_color_g, 0, 0, 100, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find and display the shortest path in ddrace using a* algorithm")
MACRO_CONFIG_INT(ClPathFindingColorB, cl_path_finding_color_b, 0, 0, 100, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find and display the shortest path in ddrace using a* algorithm")
MACRO_CONFIG_INT(ClPathFindingColorA, cl_path_finding_color_a, 70, 0, 100, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Find and display the shortest path in ddrace using a* algorithm")
MACRO_CONFIG_INT(ClShowhudMode, cl_showhud_mode, 1, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0: vanilla | 1: bars | 2: numbers")
MACRO_CONFIG_INT(ClShowhudChatbox, cl_showhud_chatbox, 0, 0, 100, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Nice background for the chat (alpha, 0-100)")
...
MACRO_CONFIG_INT(ClSmoothEmoteWheelDelay, cl_smooth_emotewheel_delay, 10, 10, 1000, CFGFLAG_CLIENT|CFGFLAG_SAVE, "How long the smooth emote wheel animation should take")
...
MACRO_CONFIG_INT(ClIRCShowJoins, cl_irc_show_joins, 0, 0, 2, CFGFLAG_CLIENT|CFGFLAG_SAVE, "0: hide all joins/leaves | 1: show in chat | 2: show in chat and notifications")
...
MACRO_CONFIG_STR(TexGame, tex_game, 128, "1_gameskin_by_Skaterfreak1996", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Gameskin texture")
MACRO_CONFIG_STR(TexParticles, tex_particles, 128, "Magic_game_skin", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Particle texture")
MACRO_CONFIG_STR(TexEmoticons, tex_emoticon, 128, "emoctions", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Emoticons texture")
MACRO_CONFIG_STR(TexCursor, tex_cursor, 128, "Blue_cursor", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Cursor texture")
...
MACRO_CONFIG_INT(ClTransChatCmds, cl_trans_chat_cmds, 0, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Enable/disable client side traslation chat commands")
...
MACRO_CONFIG_STR(ClMenuBackgroundMap, cl_menu_background_map, 64, "sash.map", CFGFLAG_CLIENT|CFGFLAG_SAVE, "Name of the map to use as menu background")
